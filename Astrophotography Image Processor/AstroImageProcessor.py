# A simple application to process and enhance astrophotography images
...
class AstroImageProcessor:
    def __init__(self, root):
        ...
        # Create brigthness slider
        self.brightness_scale = tk.Scale(self.slider_frame, from_=-1.0, to=10.0, resolution=0.01, orient=tk.HORIZONTAL, label="Brightness")
        ...
        self.contrast_scale = tk.Scale(self.slider_frame, from_=-1.0, to=1.0, resolution=0.01, orient=tk.HORIZONTAL, label="Contrast")
        self.contrast_scale.grid(row=0, column=2, padx=5, pady=5)
        self.contrast_scale.bind("<Motion>", self.adjust_image)

        # Create saturation slider
        self.saturation_scale = tk.Scale(self.slider_frame, from_=-1.0, to=1.0, resolution=0.01, orient=tk.HORIZONTAL, label="Saturation")
        self.saturation_scale.grid(row=0, column=3, padx=5, pady=5)
        self.saturation_scale.bind("<Motion>", self.adjust_image)

        # Create resize slider
        self.resize_scale = tk.Scale(self.slider_frame, from_=1.0, to=2.0, resolution=0.01, orient=tk.HORIZONTAL, label="Resize Factor")
        self.resize_scale.grid(row=0, column=1, padx=5, pady=5)
